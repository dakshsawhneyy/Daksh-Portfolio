...
const About = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-bgDark text-success px-4 py-10 md:pt-20 md :pt-20 sm:px-6 md:px-10 font-mono">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-green-600 mt-2">// A deep dive into who I am, what I build, and why I do it.</p>
      ...
      <div className="max-w-5xl mx-auto">
        {timeline.map((item, index) => (
          <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.15 }} className="mb-8 border-l-2 border-green-500 pl-4">
            <p className="text-xs text-green-500">~ {item.year}</p>
      ...
      <div className="text-center my-10">
        ...
        <p className="text-green-600 mt-2">// All the tools I wield on my terminal</p>
      </div>
      ...
      <div className="text-center mt-20 mb-10">
        ...
        <p className="text-green-600 mt-2">// Proof of execution</p>
      </div>
      ...
      <div className="text-center mt-20 mb-12">
        ...
        <p className="text-green-500 max-w-2xl mx-auto text-sm">
